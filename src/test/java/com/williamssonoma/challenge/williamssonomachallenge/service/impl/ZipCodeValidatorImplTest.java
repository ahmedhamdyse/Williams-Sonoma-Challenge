...
public class ZipCodeValidatorImplTest {
    ...
    @Test
    public void shouldHandleRandomSpaces() {
        List<ZipCode> validZipCodes = zipCodeValidator.validSortedZipCodes(Stream.of("[94133, 94133]", "[94200,94299]", "[94226,94398]"," ").collect(Collectors.toList()));
        List<ZipCode> expectedZipCodes = Stream.of(ZipCode.of(94133, 94133), ZipCode.of(94200, 94299), ZipCode.of(94226, 94398)).collect(Collectors.toList());
        assertEquals(validZipCodes, expectedZipCodes);
    }
